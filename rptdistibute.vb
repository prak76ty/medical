...
Public Class rptdistibute
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Medical_System.rptdistibute.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptdistibute
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptdistibute = New rptdistibute
        rpt.Site = Me.Site
        Return rpt
    End Function
