...
Public Class rptPurMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Medical_System.rptPurMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurMaster = New rptPurMaster
        rpt.Site = Me.Site
        Return rpt
    End Function
