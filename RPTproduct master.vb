...
Public Class RPTproduct_master
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Medical_System.RPTproduct master.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTproduct_master
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTproduct_master = New RPTproduct_master
        rpt.Site = Me.Site
        Return rpt
    End Function
