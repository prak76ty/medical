...
Public Class rptSalesMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Medical_System.rptSalesMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesMaster = New rptSalesMaster
        rpt.Site = Me.Site
        Return rpt
    End Function
