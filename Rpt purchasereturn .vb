...
Public Class Rpt_purchasereturn_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Medical_System.Rpt purchasereturn .rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_purchasereturn_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_purchasereturn_ = New Rpt_purchasereturn_
        rpt.Site = Me.Site
        Return rpt
    End Function
