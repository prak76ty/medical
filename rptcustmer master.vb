...
Public Class rptcustmer_master
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Medical_System.rptcustmer master.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptcustmer_master
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptcustmer_master = New rptcustmer_master
        rpt.Site = Me.Site
        Return rpt
    End Function
