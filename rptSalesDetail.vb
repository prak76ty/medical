...
Public Class rptSalesDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Medical_System.rptSalesDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesDetail = New rptSalesDetail
        rpt.Site = Me.Site
        Return rpt
    End Function
